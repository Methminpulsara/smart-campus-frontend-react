...
function Signup() {
  ...
  const finalSubmit =async (e) => {
   ...
   const { role, regNumber, faculty, department, position } = formData;

   if(role==="student" && (!regNumber  || !faculty || !department)){
      console.log("Student fields are required !");
      return;
   }

   if(role ==="faculty"  &&( !department || !position)){
      console.log("faculty fields are required ! ");
      return;
   }
   ...
   try{
     const paylod = {
      ...
      const response = await axiosInstance.post('/api/auth/register',paylod);
      ...
      if (role === "student") {
        await axiosInstance.post("/api/student/create-profile",{
          regNumber,
          faculty,
          department
        })
         alert("Create Student profile sussecfully ! ")

      }

      if (role === "faculty") {
        await axiosInstance.post("/api/faculty/create-profile",{
          department,
          position
        })
        alert("Create Faculty profile sussecfully ! ")
      }
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center p-4">
      <div className="max-w-lg w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-gray-900 mb-2">Join SmartCampus</h2>
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    {['student', 'faculty', 'admin'].map((role) => (
                      <button
                        ...
                        className={`px-4 py-2 rounded-xl text-sm font-medium transition-all ${formData.role === role
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all bg-gray-50 focus:bg-white"
